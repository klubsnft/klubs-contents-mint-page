...
export interface KIP17MockInterface extends utils.Interface {
    contractName: "KIP17Mock";
    functions: {
...
export interface KIP17Mock extends BaseContract {
    contractName: "KIP17Mock";
    ...
    functions: {
        ...
        "burn(uint256)"(tokenId: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        "burn(address,uint256)"(owner: string, tokenId: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "burn(address,uint256)"(owner: string, tokenId: BigNumberish, overrides?: CallOverrides): Promise<void>;
        ownerOf(tokenId: BigNumberish, overrides?: CallOverrides): Promise<string>;
        balanceOf(owner: string, overrides?: CallOverrides): Promise<BigNumber>;
...
//# sourceMappingURL=KIP17Mock.d.ts.map