...
export interface KIP17FullMock extends BaseContract {
    ...
    functions: {
        ...
        setTokenURI(tokenId: BigNumberish, uri: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        setTokenURI(tokenId: BigNumberish, uri: string, overrides?: CallOverrides): Promise<void>;
        totalSupply(overrides?: CallOverrides): Promise<BigNumber>;
...
//# sourceMappingURL=KIP17FullMock.d.ts.map