...
export interface KIP7MintableMockInterface extends utils.Interface {
    contractName: "KIP7MintableMock";
    functions: {
...
export interface KIP7MintableMock extends BaseContract {
    contractName: "KIP7MintableMock";
...
//# sourceMappingURL=KIP7MintableMock.d.ts.map