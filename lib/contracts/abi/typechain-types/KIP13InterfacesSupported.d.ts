...
export interface KIP13InterfacesSupportedInterface extends utils.Interface {
    contractName: "KIP13InterfacesSupported";
    functions: {
        "supportsInterface(bytes4)": FunctionFragment;
        "INTERFACE_ID_KIP13()": FunctionFragment;
    };
    encodeFunctionData(functionFragment: "supportsInterface", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "INTERFACE_ID_KIP13", values?: undefined): string;
    decodeFunctionResult(functionFragment: "supportsInterface", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "INTERFACE_ID_KIP13", data: BytesLike): Result;
    events: {};
}
export interface KIP13InterfacesSupported extends BaseContract {
    ...
    populateTransaction: {
        ...
        INTERFACE_ID_KIP13(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
//# sourceMappingURL=KIP13InterfacesSupported.d.ts.map