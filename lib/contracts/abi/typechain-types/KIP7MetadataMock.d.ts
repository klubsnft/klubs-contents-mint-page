...
export interface KIP7MetadataMockInterface extends utils.Interface {
    contractName: "KIP7MetadataMock";
    functions: {
...
export interface KIP7MetadataMock extends BaseContract {
    contractName: "KIP7MetadataMock";
...
//# sourceMappingURL=KIP7MetadataMock.d.ts.map