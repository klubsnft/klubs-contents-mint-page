...
export interface KIP7BurnableInterface extends utils.Interface {
    contractName: "KIP7Burnable";
    functions: {
...
export interface KIP7Burnable extends BaseContract {
    contractName: "KIP7Burnable";
...
//# sourceMappingURL=KIP7Burnable.d.ts.map