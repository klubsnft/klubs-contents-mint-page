...
export interface KIP7MockInterface extends utils.Interface {
    contractName: "KIP7Mock";
    functions: {
...
export interface KIP7Mock extends BaseContract {
    contractName: "KIP7Mock";
...
//# sourceMappingURL=KIP7Mock.d.ts.map