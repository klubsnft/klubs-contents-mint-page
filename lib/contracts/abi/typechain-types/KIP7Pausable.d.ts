...
export interface KIP7PausableInterface extends utils.Interface {
    contractName: "KIP7Pausable";
    functions: {
...
export interface KIP7Pausable extends BaseContract {
    contractName: "KIP7Pausable";
...
//# sourceMappingURL=KIP7Pausable.d.ts.map