...
declare module "hardhat/types/runtime" {
  interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
    ...
    getContractFactory(
      name: "KlubsContentsNFT",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.KlubsContentsNFT__factory>;
    getContractFactory(
      name: "KlubsContentsNFTMinter",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.KlubsContentsNFTMinter__factory>;
    ...
    getContractAt(
      ...
      address: string,
      signer?: ethers.Signer
    ): Promise<Contracts.KlubsContentsNFT>;
    getContractAt(
      name: "KlubsContentsNFTMinter",
      address: string,
      signer?: ethers.Signer
    ): Promise<Contracts.KlubsContentsNFTMinter>;
