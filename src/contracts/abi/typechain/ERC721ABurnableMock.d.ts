...
interface ERC721ABurnableMockInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC721ABurnableMock extends Contract {
  ...
  interface: ERC721ABurnableMockInterface;
