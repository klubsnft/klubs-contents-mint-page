...
interface ERC721AQueryableMockInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC721AQueryableMock extends Contract {
  ...
  interface: ERC721AQueryableMockInterface;
