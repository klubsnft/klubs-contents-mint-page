...
interface YabaiGoblinInterface extends ethers.utils.Interface {
  functions: {
...
export class YabaiGoblin extends Contract {
  ...
  interface: YabaiGoblinInterface;
  ...
  filters: {
    ...
    SetMinter(minter: null): EventFilter;
